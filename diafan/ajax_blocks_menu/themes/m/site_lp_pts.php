...
<div class="slide">
  ...
  <!-- <div id="center-col"> -->
    <h1 class="for_h1">Автоломбард "Ваш финансистъ": <br>деньги под залог ПТС в Казани</h1>
	<p>Срочно нужны наличные? Предлагаем простое и быстрое решение - деньги под залог ПТС автомобиля. Авто остается у вас, в качестве залога оставляете только паспорт транспортного средства. Мы предлагаем очень выгодные условия: максимальную сумму и минимальные процентные ставки.</p>
