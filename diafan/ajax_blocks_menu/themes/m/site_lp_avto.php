...
<div class="slide">
  ...
  <!-- <div id="center-col"> -->
<h1 class="for_h1">Автоломбард "Ваш финансистъ":<br>
кредит заем под залог авто в Казани</h1>
<p>Срочно нужны деньги? Предлагаем простое и быстрое решение - займ под залог автомобиля. Этот вид кредитования позволяет получить на руки до 5 000 000 всего за полчаса.</p>
