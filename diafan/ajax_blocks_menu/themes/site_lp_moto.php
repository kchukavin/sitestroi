<?php
/**
 * Посадочная страница "Деньги под залог мотоцикла"
 */
  ...
  <div class="mini">
	  ...
	  <div class="all">
		  <div class="row">
			  <div class="col-md-8 vitrina__desc">
				  ...
				  <div class="vitrina__txt1">Кредит под залог <span class="vitrina__txt2">мотоцикла</span></div>
			  </div>
			  <div class="col-md-4">
    ...
    <div class="all">
	  <div class="content clearfix">
		...
		-->	
			<h1 class="heading1_topline">Автоломбард в Казани:<br>кредит под залог мотоцикла</h1>
			
			<p class="top-text">
				Займ под залог мотоцикла от 4,5% до 6% в месяц<!--, от 3 дней-->. Выдаем деньги за 30 минут. До 5 000 000 рублей наличными без подтверждения доходов. Самый простой и быстрый способ получить нужную сумму!
			</p>
		  ...
		  <ul class="list_done clearfix">
		    ...
		    <li class="for_low clearfix">
			  ...
			  <ul class="so_list">
				<li>Ваш паспорт, свидетельство и птс мотоцикла</li>
			  </ul>
			  <!--<div class="text-center">
		    ...
		    <li class="for_low clearfix marginr">
			  ...
			  <p class="fo_step">Безопасность</p>
			  <ul class="so_list">
				<li>Хранение мототехники на охраняемой стоянке</li>
	          </ul><!--so_list-->
			  <!--<div class="text-center">
				  ...
				  <h3><p align="center">Хотите получить до 85% от рыночной стоимости мотоцикла?</p></h3>
<p>При этом он будет под надежной охраной на нашей стоянке, при этом совершенно бесплатно! Вы не будете думать о том, как же там ваш стальной друг.</p>

</div>
			<div class="view_block_clearfix">
	      <h2 class="for_h2">Условия займа под залог мотоцикла<br/> в автоломбарде «Ваш финансистъ» в Казани</h2>
		  	<ul class="so_list">
				...
				<div style="float: right; width: 49%;">
		  		...
		  		<li>Вы получаете до 85% от рыночной стоимости мотоцикла</li>
				</div><div class="clear">
			 </ul>
			 </div>
	...
	<div class="for_same_width">
	  ...
	  <div class="for_done_clearfix">
		  <h3><p align="center">В чем главные отличия банка и автоломбарда:</p></h3>
			  <p>К нам обращаются люди даже с плохой кредитной историей, и, в отличие от банка, у нас они не получают отказов в 99% случаев.</p>
			<ul class="so_list">
				<div style="float: left; width: 49%;">
				<li>Оперативность – от подачи заявки до получения денег пройдет не более одного дня</li>
				<li>Доступность – взять заем под залог мототехники можно без справок и поручителей. С любой кредитной историей.</li>
				</div>
				<div style="float: right; width: 49%;">
				<li>Выгода – проценты начисляются по дням. Вы не переплачиваете за лишнее время.</li>
				<li>В автоломбарде автозайм под залог мотоцикла может получить любой собственник.</li>
				</div>
				</ul>
				<p>Банки очень требовательны к заёмщику и его мотоциклу, поэтому лучше обратиться в автоломбард Казани, чтобы не тратить нервы и время понапрасну.</p>
				</div>
	  <div class="all">
		...
		<div class="doveryaut">
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<p>
						Взять деньги под залог мотоцикла можно без справок и поручителей. С любой кредитной историей.
					</p>
				</div>
				<div class="col-md-4">
					<div class="text-center">
					...
					<p>
						Вы получаете в кредит наличными под залог мотоцикла до 85% стоимости залога.
					</p>
				</div>
				<div class="col-md-4">
					<div class="text-center">
...
-->
	...
	<div class="vitrina vitrina_text-form">
		<div class="all">
			<div class="heading2">
				Взять деньги под залог мототехники у<br>
			...
			<div class="row">
				<div class="col-md-8 vitrina__maintext">
					<p>
						Если вы хотите получить некоторую сумму денег, а под залог ПТС предлагают слишком мало, кредит под залог мотоцикла - оптимальный вариант для вас. Вам не придется собирать большой пакет документов, достаточно паспорта, свидетельства о регистрации мото и ПТС. Также не нужны поручители и подтверждение доходов. Не имеет значения и кредитная история. Все время, пока вы пользуетесь займом, мотоцикл находится на надежно охраняемой стоянке. Одобряем 100%. Отправьте заявку через форму справа или звоните по телефону 8 (843) 216 66 86.
