<?php
/**
 * Посадочная страница "Деньги под залог спецтехники"
 */
  ...
  <div class="mini">
	  ...
	  <div class="all">
		  <div class="row">
			  <div class="col-md-8 vitrina__desc">
				  ...
				  <div class="vitrina__txt1">Деньги под залог <span class="vitrina__txt2">спецтехники</span></div>
			  </div>
			  <div class="col-md-4">
    ...
    <div class="all">
	  <div class="content clearfix">
		...
		-->	
			<h1 class="heading1_topline">Автоломбард в Казани:<br>кредит под залог спецтехники</h1>
			
			<p class="top-text">
				Займ под залог спецтехники от 4,5% до 6% в месяц<!--, от 3 дней-->. Выдаем деньги за 30 минут. До 5 000 000 рублей наличными без подтверждения доходов. Самый простой и быстрый способ получить нужную сумму!
			</p>
		  ...
		  <ul class="list_done clearfix">
		    ...
		    <li class="for_low clearfix marginr">
			  ...
			  <ul class="so_list">
				<li>Техника остается на надежно охраняемой стоянке</li>
	          </ul><!--so_list-->
			  <!--<div class="text-center">
...
<p>Вам не придется подтверждать свои доходы, беспокоиться за кредитную историю и искать посредников.</p>
<p>У вас есть возможность гасить займы равными платежами или выплачивать только проценты и в конце займа вернуть всю занимаемую сумму.</p>
</div>
			<div class="view_block_clearfix">
	      <h2 class="for_h2">Условия займа под залог спецтехники<br/> в автоломбарде «Ваш финансистъ» в Казани</h2>
		  	<ul class="so_list">
				...
				<div style="float: right; width: 49%;">
		  		...
		  		<li>Вы получаете до 85% от рыночной стоимости техники</li>
				</div><div class="clear">
			 </ul>
			 </div>
	...
	<div class="for_same_width">
	  ...
	  <div class="for_done_clearfix">
		  <h3><p align="center">В чем главные отличия банка и автоломбарда:</p></h3>
			  <p>У банков слишком строгие требования к потенциальным заёмщикам. Нужна кипа документов, чистая кредитная история и прочая “официальщина”.</p>
			<ul class="so_list">
				<div style="float: left; width: 49%;">
				<li>Оперативность – от подачи заявки до получения денег пройдет не более одного дня</li>
				<li>Доступность – взять заем под залог спецтехники можно без справок и поручителей. С любой кредитной историей.</li>
				</div>
				<div style="float: right; width: 49%;">
				<li>Выгода – проценты начисляются по дням. Вы не переплачиваете за лишнее время.</li>
				<li>В автоломбарде автозайм под залог техники может получить любой собственник машины</li>
				</div>
				</ul>
		...
		<div class="doveryaut">
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<p>
						Взять деньги под залог спецтехники можно без справок и поручителей. С любой кредитной историей.
					</p>
				</div>
				<div class="col-md-4">
					<div class="text-center">
					...
					<p>
						Вы получаете в кредит наличными под залог техники до 85% стоимости залога.
					</p>
				</div>
				<div class="col-md-4">
					<div class="text-center">
...
-->
	...
	<div class="vitrina vitrina_text-form">
		<div class="all">
			<div class="heading2">
				Взять деньги под залог спецтехники у<br>
			...
			<div class="row">
				<div class="col-md-8 vitrina__maintext">
					<p>
						Если вы хотите получить некоторую сумму денег, а под залог ПТС предлагают слишком мало, кредит под залог спецтехники - оптимальный вариант для вас. Вам не придется собирать большой пакет документов, достаточно паспорта, свидетельства о регистрации авто и ПТС. Также не нужны поручители и подтверждение доходов. Не имеет значения и кредитная история. Все время, пока вы пользуетесь займом, автомобиль находится на надежно охраняемой стоянке. Если ваш автомобиль исправен, растаможен и не находится в залоге - одобряем 100%. Отправьте заявку через форму справа или звоните по телефону 8 (843) 216 66 86.
