...
$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
	...
	var newUrl = strippedUrl + target;

	history.pushState('tab', 'title', newUrl);

});

// Установка вкладки, если есть её id в url
var urlArray = (window.location.href).split('#');
if(typeof urlArray[1] !== 'undefined') {
    $('.nav-tabs a[href="#'+ urlArray[1] +'"]').tab('show');
}

// Отключение перепрыгивания скролла на таб
if (location.hash) {
  setTimeout(function() {
